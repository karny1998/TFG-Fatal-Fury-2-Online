...
public class ia_loader {
    ...
    public static Pair<Pair<ia_processor,russian_roulette>, Pair<ia_type[], Double[][]>> loadIA(Playable_Character c){
        ...
        rr.fillRoulette();
        ia_type m[] = {ia_type.AGRESSIVE, ia_type.DEFENSIVE, ia_type.AGRESSIVE, ia_type.DEFENSIVE};
        Double aux[][]  ={{0.35, 0.15, 0.15, 0.25, 0.2}, {0.35, 0.15, 0.15, 0.25, 0.2},{0.35, 0.15, 0.15, 0.25, 0.2},{0.35, 0.15, 0.15, 0.25, 0.2}};
        return new Pair<Pair<ia_processor,russian_roulette>, Pair<ia_type[], Double[][]>>(new Pair<>(new processor_life_round_based(), rr), new Pair<ia_type[], Double[][]>(m, aux));
    }
}
