...
public class user_controller extends character_controller{
    ...
    public screenObject getAnimation(boolean collides){
        ...
        controlKey array1[] = {controlKey.LEFT, controlKey.RIGHT, controlKey.DOWN, controlKey.UP, controlKey.A, controlKey.S, controlKey.D, controlKey.W};
        String array2[] = {"LEFT", "RIGHT", "DOWN", "UP", "A","S", "D", "W"};
